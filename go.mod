...
require (
	...
	github.com/Station-Manager/database v0.0.44
	github.com/Station-Manager/email v0.0.4
	github.com/Station-Manager/enums v0.0.6
	github.com/Station-Manager/errors v0.0.11
	github.com/Station-Manager/forwarding v0.0.4
...
require (
	github.com/Station-Manager/adif v0.0.3 // indirect
